...
ALTER TABLE COMMENT_LIKE ADD CONSTRAINT COMMENT_LIKE_COMMNET_CODE_FK FOREIGN KEY(COMMENT_CODE) REFERENCES VIDEO_COMMENT;
...
CREATE SEQUENCE SEQ_COMMIT_LIKE;
...
VALUES(SEQ_VIDEO.NEXTVAL, '250만원 받던 직장 그만두고 귀어해서 하루 500만원 버는 39살', 'URL01', 'PHOTO01', 1, 2, 'user1');
